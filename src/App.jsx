...
const PAGES = { home: Home, cohesive: CohesiveFit, bench: Benchmark, hof: Hofstede, cohesive: CohesiveFit, signals: Signals, opp: Opportunities, mini: MiniQueue, learn: Learning, inbox: ContentInbox, release: Release }
